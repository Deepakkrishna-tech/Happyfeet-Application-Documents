...
Dependencies: DOMAIN_OVERVIEW.md, BUSINESS_CAPABILITY_MODEL.md
...
**Source:** PRODUCT_OVERVIEW_v2.md, DOMAIN_OVERVIEW.md, BUSINESS_CAPABILITY_MODEL.md
**Date:** 2026-06-04
**Status:** Complete
...
└── Teacher flags welfare concern from attendance or daily activity log screen
...
| Daily activity log entries | Yes | Yes | Yes (read-only) | Own class | No | Own child (read-only, 30-day feed) |
