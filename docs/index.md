...
| M2 | Academic Configuration | Academic year, terms, programmes, classes, calendar, timetable, milestones, document types — the framework all other modules depend on |
| M3 | Student Information System | Permanent student profiles, documents, medical records, pickup lists, incident reports, welfare concern records |
| M4 | Staff Management | Employment records, salary history, certification tracking with expiry alerts, leave management, staff exit gates, visitor log |
...
| M9 | Progress Tracking | Progress card authoring, delegate review, Branch Admin review and publication, PDF generation, submission window management |
...
| M11 | Reports & Analytics | Role-filtered dashboards, CSV exports, audit log access, governance log, monthly governance digest |
| M12 | Daily Activity Log | Per-child structured daily records — meals, naps, activities, health checks, general notes — as the primary parent engagement channel |
