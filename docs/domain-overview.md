...
- School configuration (year, terms, programmes, classes, calendar, timetable, milestones)
- Student records (profiles, documents, medical, pickup lists, incident reports)
- Staff records (profiles, attendance, leave, certifications, exit)
